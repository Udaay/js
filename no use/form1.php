  ...
  <center>
    ...
    <form method="post" action="form1.php" enctype="multipart/form-data">
      <table>
        <tr>
          <td>Product Id:</td>
          <td><input type="text" name="productid" id="productid" maxlength="10" size="10"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="text" name="startingprice" id="startingprice" size="10"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="text" name="warrantyperiod" id="warrantyperiod" size="10"></td>
        </tr>
